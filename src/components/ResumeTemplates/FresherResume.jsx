        ...
        >
          <IconContext.Provider value={{ className: "contact-icons" }}>
            ...
            >
              <AiOutlineLinkedin />
              <Link
                href={basicInfo?.linkedin ? basicInfo?.linkedin : ""}
                sx={{ fontSize: { xs: "0.5rem", sm: "1rem" } }}
              >
                LinkedIn
              </Link>
            ...
            >
              <AiOutlineGithub />
              <Link
                href={basicInfo?.github ? basicInfo?.github : ""}
                sx={{ fontSize: { xs: "0.5rem", sm: "1rem" } }}
              >
                GitHub
              </Link>
                  ...
                  sx={{
                    ...
                    margin:
                      index === 0
                        ? "0.25rem 0"
                        : {
                            xs: "0.55rem 0 0.2rem 0",
                            sm: "0.85rem 0 0.2rem 0",
                          },
                  }}
                >
                  <Typography
        ...
        {projects.length >= 1 ? (
          ...
          <>
            ...
            <Box sx={{ display: "flex", gap: "0.2rem" }}>
              ...
              <Link href="" sx={{ fontSize: { xs: "0.4rem", sm: "0.9rem" } }}>
